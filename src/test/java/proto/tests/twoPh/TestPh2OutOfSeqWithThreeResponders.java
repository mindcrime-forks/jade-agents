 ...
 */
public class TestPh2OutOfSeqWithThreeResponders extends Test {
    ...
    r1 = TestUtility.createAgent(a, R1, "test.proto.tests.twoPh.TestPh2OutOfSeqWithThreeResponders$Responder", null);
    r2 = TestUtility.createAgent(a, R2, "test.proto.tests.twoPh.TestPh2OutOfSeqWithThreeResponders$Responder", null);
    r3 = TestUtility.createAgent(a, R3, "test.proto.tests.twoPh.TestPh2OutOfSeqWithThreeResponders$SimpleResponder", null);
    ...
    Behaviour b = new TwoPhInitiator(a, cfp) {
        ...
        protected void handleConfirm(ACLMessage confirm) {
              ...
              if(!confirm.getSender().getLocalName().equals(R1) &&
                ...
                !confirm.getSender().getLocalName().equals(R3)) {
                l.log("\n\nLOG - (TwoPhInitiator, handleConfirm(), " + myAgent.getLocalName() + ") - " +
                confirm.getSender().getLocalName() + " sender while r1 or r2 or r3 were expected.");
                success = success && false;
              }
        }
        ...
        /* PHASE 2 */
          protected void handleNotUnderstood(ACLMessage notUnderstood) {
              ...
              if(!getCurrentPhase().equals(TwoPhInitiator.PH2_STATE)) {
                    l.log("\n\nLOG - (TwoPhInitiator, handleNotUnderstood(), " + myAgent.getLocalName() + ") - " +
                        getCurrentPhase() + " while ph2 was expected.");
                    success = success && false;
              }
          }
        ...
        protected void handlePh2Inform(ACLMessage inform) {
            ...
            if(!inform.getSender().getLocalName().equals(R1) &&
                !inform.getSender().getLocalName().equals(R2) &&
                !inform.getSender().getLocalName().equals(R3)) {
                l.log("\n\nLOG - (TwoPhInitiator, handlePh2Inform(), " + myAgent.getLocalName() + ") - " +
                    inform.getSender().getLocalName() + " sender while r1 or r2 or r3 were expected.");
                success = success && false;
            }
        }
          ...
          protected void handleAllPh2Responses(Vector responses) {
            ...
            if (cnt != 3) {
                l.log("\n\nLOG - (TwoPhInitiator, handleAllPh2Responses(), " + myAgent.getLocalName() + ") - " +
                        cnt+" informs received while 3 was expected.");
                success = success && false;
            }
            else {
