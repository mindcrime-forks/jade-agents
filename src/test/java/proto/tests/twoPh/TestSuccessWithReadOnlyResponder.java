 ...
 */
public class TestSuccessWithReadOnlyResponder extends Test {
  ...
  public Behaviour load(Agent a, DataStore ds, String resultKey) throws TestException {
    ...
    r1 = TestUtility.createAgent(a, R1, "test.proto.tests.twoPh.TestSuccessWithReadOnlyResponder$Responder",
            new String[] {ACLMessage.getPerformative(ACLMessage.CONFIRM)});
    r2 = TestUtility.createAgent(a, R2, "test.proto.tests.twoPh.TestSuccessWithReadOnlyResponder$Responder",
            new String[] {ACLMessage.getPerformative(ACLMessage.CONFIRM)});
    r3 = TestUtility.createAgent(a, R3, "test.proto.tests.twoPh.TestSuccessWithReadOnlyResponder$Responder",
