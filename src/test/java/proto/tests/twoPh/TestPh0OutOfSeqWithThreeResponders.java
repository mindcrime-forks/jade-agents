 ...
 */
public class TestPh0OutOfSeqWithThreeResponders extends Test {
    ...
    r1 = TestUtility.createAgent(a, R1, "test.proto.tests.twoPh.TestPh0OutOfSeqWithThreeResponders$Responder", null);
    r2 = TestUtility.createAgent(a, R2, "test.proto.tests.twoPh.TestPh0OutOfSeqWithThreeResponders$Responder", null);
    r3 = TestUtility.createAgent(a, R3, "test.proto.tests.twoPh.TestPh0OutOfSeqWithThreeResponders$SimpleResponder", null);
    ...
    Behaviour b = new TwoPhInitiator(a, cfp) {
        ...
        protected void handlePropose(ACLMessage propose) {
              ...
              if(!propose.getSender().getLocalName().equals(R1) &&
                    ...
                    l.log("\n\nLOG - (TwoPhInitiator, handlePropose(), " + myAgent.getLocalName() + ") - " +
                    propose.getSender().getLocalName() + " sender while r1 or r2 were expected.");
        ...
        protected void handleFailure(ACLMessage failure) {
          ...
          protected void handleNotUnderstood(ACLMessage notUnderstood) {
              ...
              if(!getCurrentPhase().equals(TwoPhInitiator.PH0_STATE)) {
                    l.log("\n\nLOG - (TwoPhInitiator, handleNotUnderstood(), " + myAgent.getLocalName() + ") - " +
                        getCurrentPhase() + " while ph0 was expected.");
                    success = success && false;
              }
          }
          ...
          protected void handleOutOfSequence(ACLMessage msg) {
              ...
              if(msg.getPerformative() != ACLMessage.QUERY_IF) {
                    l.log("\n\nLOG - (TwoPhInitiator, handleOutOfSequence(), " + myAgent.getLocalName() + ") - " +
                        ACLMessage.getPerformative(msg.getPerformative()) + " message while QUERY_IF was expected.");
                    success = success && false;
              }
              if(!getCurrentPhase().equals(TwoPhInitiator.PH0_STATE)) {
                    l.log("\n\nLOG - (TwoPhInitiator, handleOutOfSequence(), " + myAgent.getLocalName() + ") - " +
                            ...
                            public void onTick() {
                               switch(getTickCount()) {
                                   case 1:
                                       ...
                                       break;
                                   case 2:
                                       ACLMessage queryIf = cfp.createReply();
