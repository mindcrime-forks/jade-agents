...
public class TestExitWhenEmptyOnSplitContainerNIO extends TestExitWhenEmptyOnSplitContainerBasic{
	...
	protected String createSplitContainer() throws TestException{
		...
		jc = TestUtility.launchSplitJadeInstance("Split-Container-1", null, new String("-host "+TestUtility.getContainerHostName(myAgent, jc1.getContainerName())+" -port 2099" + " -mediator-class jade.imtp.leap.nio.NIOBEDispatcher -exitwhenempty true"));
